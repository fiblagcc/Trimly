...
Trimly is a barbershop appointment web app. It must be **genuinely functional** (real
Supabase auth + Postgres + RLS + realtime, real accounts log in) and **look
distinctive/premium**, not a purchased template or AI-SaaS slop. Treat it as a real
product; never frame it as a school or class assignment in anything user-facing.
